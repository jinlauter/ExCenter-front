...
// =============================================================================
// ExamReportBody — o "nosso laudo" propriamente dito
// =============================================================================
// Template inspirado na anatomia do laudo impresso brasileiro: cabeçalho com paciente, data de
// coleta, médico e laboratório; painéis na ordem do documento com "(Material: X) (Método: Y)";
// linhas Exame | Resultado | Valor de Referência — e, como os próprios laboratórios fazem, um
// "Gráfico de Histórico" por parâmetro. A diferença: o histórico deles usa só a base do próprio
// lab; o nosso cruza todos os exames que o usuário já enviou.
//
// Está separado do ExamDetailView porque tem DOIS consumidores reais: a página do exame (com
// navegação e as três ações) e a página pública de um exame compartilhado (sem menu, com uma
// ação só). O que muda entre as duas é a moldura; o documento é o mesmo, e duplicá-lo faria as
...
// permite a página pública renderizá-lo a partir de um snapshot congelado, sem tocar na API
// autenticada.
export function ExamReportBody({ exam }: { exam: ExamDetailResponse }) {
    ...
    <div className="space-y-4">
      <Card className="border-border p-4">
        <div className="flex flex-wrap gap-x-8 gap-y-3 text-sm">
          {/* Paciente primeiro: num documento que pode ser compartilhado, é o dado que diz de
              QUEM é o exame — e é o que quem recebe confere contra o laudo original. */}
          <div>
            <p className="text-[11px] uppercase tracking-wide text-muted-foreground">Paciente</p>
            <p className="font-medium">{exam.patientName || <MissingValue label="o nome do paciente" />}</p>
          </div>
          <div>
